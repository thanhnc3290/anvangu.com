<div id="home_nha_dat_ban_moi_nhat" class="row">
...
<script>
    ...
    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)){
        //giao diện mobile
        document.getElementById('home_nha_dat_ban_moi_nhat').innerHTML = `
            <div class="col-12">
				<div class="mt-5 mb-3">
					<h2 class="m-0 display-flex flex-center">
						<a class="flex-first text-title-group-home color-name" href="<?php echo base_url('danh-sach-bds-mua-nha-dat/?du_an_status=0&loai_hinh_mua_ban_bds=Mua Bán') ?>">
					...
					<div id="product-for-buy-sale-1" class="box-show-container ProductForSale">
                        <div class="">
                            <div class="re-slider no-scrollbar" id="popular-slider-1">
                                <?php foreach($nha_data_ban_moi_nhat as $row): ?>
                                                <?php 
        ...
        document.getElementById('home_nha_dat_ban_moi_nhat').innerHTML = `
            <div class="col-12">
                <div class="mt-3 mb-3">
                    <h2 class="m-0 display-flex flex-center">
                        <a class="flex-first text-title-group-home text-gray" href="<?php echo base_url('danh-sach-bds-mua-nha-dat/?du_an_status=0&loai_hinh_mua_ban_bds=Mua Bán') ?>">Nhà đất bán mới nhất</a>
                        <a class="btn btn-outline-success btn-rounded view-all-group-home" href="<?php echo base_url('danh-sach-bds-mua-nha-dat/?du_an_status=0&loai_hinh_mua_ban_bds=Mua Bán') ?>">Xem tất cả</a>
                    </h2>
                </div>
                <div class="mt-2">
                    <div id="" class="box-show-container">
                        <div class="pt-2 pb-3 mb-3">
                            <div class="by-category-slider owl-carousel owl-theme owl-has-dot owl-loaded owl-drag mixedSlider_1" id="">
