<div class="mt-4 box-show-container">
    <div class="box-container-inner grid-auto-project pb-2 mb-3">
        <!-- Foreach-->
        <?php //print_r($list); ?>
            ...
            <div class="box-item rounded hidden bg-white border h-full project-item-slider">
                <div class="image project-item-image div-relative text-center">
                    <a href="<?php echo $url_of_row ?>" target="_blank">
                        <img alt="<?php echo $name ?>" class="image-hover image-resize lazy" src="<?php echo base_url('upload/project/'.$list_image['0']); ?>">
                    </a>
                    ...
                    <div class="like-fixed-top  icon-heart-780"></div>

                    <div class="number-photo-product cursor">
                        <i class="fa fa-picture-o"></i>
                        <?php echo count($list_image); ?>
                    </div>
                </div>
                <div class="pl-2 pr-2 pt-3 pb-3">
                    <h2 class="text-large m-0 name-project">
                        <a href="<?php echo $url_of_row ?>" title="<?php echo $name ?>" class="limit-line limit-line-1 color-name text-500 line-26">
                            <?php echo $name ?>
                        </a>
                    </h2>
                    ...
                    <div class="list-option-project-index text-medium-s">
                        <div class="mt-2 display-flex flex-center text-gray line-22">
                            ...
                            <span class="limit-line-1 limit-line" title="<?php echo $location; ?>">
                                <?php echo $location; ?>
                            </span>
