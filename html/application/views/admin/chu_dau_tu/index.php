...
<head>
  ...
  <title>Anvangu.com | Danh Sách Chủ Đầu Tư</title>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <a href="<?php echo admin_url('chu_dau_tu/add') ?>" type="button" class="btn btn-block btn-success">Tạo mới Chủ Đầu Tư</a>
          </div>
          <div class="col-sm-2">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Danh sách Chủ Đầu Tư</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
                  ...
                  <tbody>
                    <?php 
                      ...
                      foreach($list as $row){
                        ...
                        $action     = '<a href="'.admin_url('chu_dau_tu/edit/'.$row['id']).'"><span class="badge bg-primary" style="margin-right: 20px;">Sửa</span></a> <a href="'.admin_url('chu_dau_tu/delete/'.$row['id']).'" class="confirmation"><span class="badge bg-danger">Xóa</span></a>';
