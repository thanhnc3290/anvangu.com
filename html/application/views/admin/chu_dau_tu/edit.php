...
<head>
    ...
    <title>Anvangu.com | Chỉnh Sửa Chủ Đầu Tư</title>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Chỉnh Sửa Chủ Đầu Tư</li>
                            </ol>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6">
                                            ...
                                            <input type="text" id="" name="prefix" class="form-control"  value="<?php echo json_decode($info->prefix) ?>">
                                        </div>
                                        <div class="form-group col-6">
                            ...
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div id="image_link_preview">
                                        <center><img style='max-height:200px;' src='<?php echo base_url('upload/chu_dau_tu/'.$info->image_link) ?>'/></center>
                                    </div>
