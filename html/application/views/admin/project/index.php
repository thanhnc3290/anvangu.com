...
<head>
  ...
  <title>Anvangu.com | Danh Sách Dự Án</title>
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            <a href="<?php echo admin_url('project/add') ?>" type="button" class="btn btn-block btn-success">Tạo mới Dự Án</a>
          </div>
          <div class="col-sm-2">
                  ...
                  <tbody>
                    <?php 
                      ...
                      foreach($list as $row){
                        ...
                        $action = '<a href="'.admin_url('project/edit/'.$row['id']).'"><span class="badge bg-primary" style="margin-right: 20px;">Sửa</span></a> <a href="'.admin_url('project/delete/'.$row['id']).'" class="confirmation"><span class="badge bg-danger">Xóa</span></a>';
