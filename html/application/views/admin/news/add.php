...
<head>
    ...
    <title>Anvangu.com | Thêm mới Tin Tức</title>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select id="inputStatus" class="form-control custom-select" name="catalog_id">
                                            <option value="1">Thị Trường</option>
                                            <option value="2">Kiến Thức</option>
                                            <option value="3">Xây Dựng, Phong Thủy</option>
                                            <option value="4">Góc Tư Vấn</option>
                                            <option value="5">Phân Tích, Nhận Định</option>
                                            <option value="6">Thông Tin Quy Hoạch</option>
                                            <option value="7">Tài Chính</option>

                                            <option value="100">Giới Thiệu</option>
                                            <option value="101">Hỗ Trợ Khách Hàng</option>
                                            <option value="102">Quảng Cáo</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
