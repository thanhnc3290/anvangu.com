...
<head>
    ...
    <title>Anvangu.com | Chỉnh Sửa Tin Tức</title>
                        ...
                        <div class="col-md-4">
                            <div class="card card-secondary">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="inputStatus">Bài Viết Nổi Bật?</label>
                                        <select id="inputStatus" class="form-control custom-select" name="hot">
                                            <option value="1" <?php if($info->hot == '1') echo 'selected'; ?>>Không</option>
                                            <option value="0" <?php if($info->hot == '0') echo 'selected'; ?>>Nổi Bật</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                        <label for="inputStatus">Danh Mục:</label>
                                        <select id="inputStatus" class="form-control custom-select" name="catalog_id">
                                            <option value="1" <?php if($info->catalog_id == '1') echo 'selected'; ?>>Thị Trường</option>
                                            <option value="2" <?php if($info->catalog_id == '2') echo 'selected'; ?>>Kiến Thức</option>
                                            <option value="3" <?php if($info->catalog_id == '3') echo 'selected'; ?>>Xây Dựng, Phong Thủy</option>
                                            <option value="4" <?php if($info->catalog_id == '4') echo 'selected'; ?>>Góc Tư Vấn</option>
                                            <option value="5" <?php if($info->catalog_id == '5') echo 'selected'; ?>>Phân Tích, Nhận Định</option>
                                            <option value="6" <?php if($info->catalog_id == '6') echo 'selected'; ?>>Thông Tin Quy Hoạch</option>
                                            <option value="7" <?php if($info->catalog_id == '7') echo 'selected'; ?>>Tài Chính</option>

                                            <option value="100" <?php if($info->catalog_id == '100') echo 'selected'; ?>>Giới Thiệu</option>
                                            <option value="101" <?php if($info->catalog_id == '101') echo 'selected'; ?>>Hỗ Trợ Khách Hàng</option>
                                            <option value="102" <?php if($info->catalog_id == '102') echo 'selected'; ?>>Quảng Cáo</option>
                                        </select>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div id="image_link_preview">
                                        <center><img style='max-height:200px;' src='<?php echo base_url('upload/news/'.$info->image_link) ?>'/></center>
                                    </div>
