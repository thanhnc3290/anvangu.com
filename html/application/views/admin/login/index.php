...
<head>
    ...
    <!-- icheck bootstrap -->
    <link rel="stylesheet"
        href="<?php echo public_url('admin/AdminLTE-master/')?>plugins/icheck-bootstrap/icheck-bootstrap.min.css">
    <!-- Theme style -->
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <b>Trang Quản Trị Anvangu.com</b>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                <p class="login-box-msg">Login vào tài khoản quản trị</p>
